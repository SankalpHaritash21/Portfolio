...
const EmailSection = () => {
  ...
  return (
    <section
      id="contact"
      className="flex flex-col md:flex-row relative w-full items-start justify-center"
    >
      <div className="md:w-1/2">
        ...
        <div className="z-10">
          ...
          <p className="text-[#ADB7BE] mb-4 max-w-md">
            Contact: <span className="underline">9001778190</span>
          </p>
          <p className="text-[#ADB7BE] mb-4 max-w-md">
            Email: <span className="underline">sanklpkaushik21@gmail.com</span>
          </p>
          <div className="socials flex flex-row gap-2">
            <Link href="https://github.com/SankalpHaritash21" target="_blank">
